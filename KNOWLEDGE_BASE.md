...
<!-- ranking_model: v1.0 | weights: {ppr:0.45,auth:0.2,test:0.15,doc:0.1,fresh:0.1} | alpha:0.85 | commit:46f13bb | date:2026-07-18 -->
...
|------|------|-----------|-----|-----------|------|-----|
| 1 | `model.py` | 0.1259 | 0.1197 | 0.1197 | 0.00 | 0.48 |
| 2 | `continuation.py` | 0.1216 | 0.0947 | 0.0947 | 0.00 | 0.60 |
| 3 | `topogpt3.c` | 0.1137 | 0.1345 | 0.1345 | 0.00 | 0.26 |
| 4 | `app.py` | 0.1111 | 0.0170 | 0.0170 | 0.00 | 1.00 |
| 5 | `gradio_app.py` | 0.1111 | 0.0170 | 0.0170 | 0.00 | 1.00 |
| 6 | `__main__.py` | 0.1111 | 0.0170 | 0.0170 | 0.00 | 1.00 |
| 7 | `test_lens_model.py` | 0.1022 | 0.0170 | 0.0170 | 0.00 | 0.91 |
| 8 | `test_jlens.py` | 0.1013 | 0.0170 | 0.0170 | 0.00 | 0.90 |
| 9 | `inference_hrm.py` | 0.0945 | 0.0219 | 0.0219 | 0.00 | 0.80 |
| 10 | `inference.py` | 0.0938 | 0.0219 | 0.0219 | 0.00 | 0.80 |
...
|------|-------|-------------|----------|
| `model.py` | 36.7 | | 0.1197 |
| `topogpt3.c` | 27.9 | | 0.1345 |
| `lens_model.py` | 14.9 | | 0.0000 |
| `train.py` | 14.2 | | 0.0000 |
| `inference_hrm.py` | 13.6 | | 0.0219 |
| `harness.py` | 13.2 | | 0.0000 |
| `jlens.py` | 12.9 | | 0.0000 |
| `__main__.py` | 12.1 | | 0.0170 |
| `__init__.py` | 12.0 | | 0.0000 |
...
- `governor.py` <-> `jlens.py` (6 hops, across 2 communities)
- `sandbox_smoke.py` <-> `test_jlens.py` (6 hops, across 2 communities)
...
| `topogpt3.c` | 0.529 | 0.389 | 0.445 | 99 | 14 |
...
|------|------------------|----------------------|--------------|
| `continuation.py` | 3 | 10 | 13 |
| `synthetic_dataset.py` | 1 | 11 | 12 |
| `model.py` | 7 | 4 | 11 |
| `topogpt3.c` | 9 | 2 | 11 |
| `sandbox.py` | 2 | 3 | 5 |
| `lens_model.py` | 5 | 0 | 5 |
