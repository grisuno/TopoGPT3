...
- `governor.py` <-> `chat.py` (6 hops, across 3 communities)
- `governor.py` <-> `eval_toolcall.py` (6 hops, across 3 communities)
- `governor.py` <-> `inference.py` (6 hops, across 3 communities)
- `governor.py` <-> `inference_hrm.py` (6 hops, across 3 communities)
