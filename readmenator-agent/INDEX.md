...
| `tests/test_heritage.py` | - | tests | 9 |
...
| `topogpt3/chat.py` | - | topogpt3 | 7 |
| `topogpt3/continuation.py` | - | topogpt3 | 5 |
| `topogpt3/convert.py` | - | topogpt3 | 3 |
| `topogpt3/eval_toolcall.py` | - | topogpt3 | 2 |
| `topogpt3/export_chat.py` | - | topogpt3 | 5 |
...
| `topogpt3/lora.py` | - | topogpt3 | 12 |
| `topogpt3/model.py` | - | topogpt3 | 188 |
| `topogpt3/rewards.py` | - | topogpt3 | 9 |
| `topogpt3/rollout.py` | - | topogpt3 | 10 |
| `topogpt3/tools_agent.py` | - | topogpt3 | 2 |
| `topogpt3/train.py` | - | topogpt3 | 62 |
| `topogpt3/train_agent.py` | - | topogpt3 | 2 |
| `topogpt3/train_distill.py` | - | topogpt3 | 1 |
| `topogpt3/train_dpo.py` | - | topogpt3 | 2 |
| `topogpt3/train_grpo.py` | - | topogpt3 | 2 |
| `topogpt3/train_lora.py` | - | topogpt3 | 2 |
| `topogpt3/train_ppo.py` | - | topogpt3 | 4 |
| `topogpt3/trainer_utils_topo.py` | - | topogpt3 | 10 |
| `topogpt3/yarn.py` | - | topogpt3 | 3 |
