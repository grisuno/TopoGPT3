...
- Layer: testing
- Doc: Advanced-training tests: LoRA/RL/chat modules preserve quaternionic identity.
- Language: py
- Symbols:
  - `_micro` (function, line 18) `def _micro()`
  - `test_chat_template_tools_think` (function, line 24) `def test_chat_template_tools_think()`
  - `test_yarn_changes_freqs_only` (function, line 37) `def test_yarn_changes_freqs_only()`
  - `test_lora_zero_init_and_quaternion_targets` (function, line 47) `def test_lora_zero_init_and_quaternion_targets()`
  - `test_lora_save_load` (function, line 64) `def test_lora_save_load(tmp_path)`
  - `test_dpo_grpo_losses_finite` (function, line 76) `def test_dpo_grpo_losses_finite()`
  - `test_distill_loss_finite` (function, line 96) `def test_distill_loss_finite()`
  - `test_rollout_engine_micro` (function, line 106) `def test_rollout_engine_micro()`
  - `test_tools_and_eval` (function, line 123) `def test_tools_and_eval()`
